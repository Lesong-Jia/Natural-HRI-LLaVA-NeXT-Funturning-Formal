...
# === 路径设置：按你当前的目录结构来 ===
DATA_ROOT = "/home/lesong_llava/Natural-HRI-LLaVA-NeXT-Funturning-Formal/Training&Test_Code/RNN"
IMAGE_ROOT = os.path.join(DATA_ROOT, "Image")
CSV_PATH = os.path.join(DATA_ROOT, "Instruction.csv")
OUT_PATH = os.path.join(DATA_ROOT, "llava_lora_dataset_RNN.jsonl")
