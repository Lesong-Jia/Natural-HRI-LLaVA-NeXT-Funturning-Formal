...
# === 路径设置：按你当前的目录结构来 ===
DATA_ROOT = "/home/lesong_llava/Natural-HRI-LLaVA-NeXT-Funturning-Formal/Training&Test_Code/UCN"
IMAGE_ROOT = os.path.join(DATA_ROOT, "Image")
CSV_PATH = os.path.join(DATA_ROOT, "Instruction.csv")
OUT_PATH = os.path.join(DATA_ROOT, "llava_lora_dataset_UCN.jsonl")
...
SYSTEM_PROMPT = (
    ...
    "Some frames may include a red triangle marker when valid gaze data is available; "
    "when present, it indicates the user's estimated gaze point (the average gaze position within ±0.5s of that frame), "
    "which may help identify the referred object.\n"
